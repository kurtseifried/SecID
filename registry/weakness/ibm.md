...
sources:
  ai-risk-atlas:
    ...
    id_pattern: "[a-z-]+"
    examples:
      - "secid:weakness/ibm/ai-risk-atlas#hallucination"
      - "secid:weakness/ibm/ai-risk-atlas#prompt-injection"
      - "secid:weakness/ibm/ai-risk-atlas#jailbreaking"
---
...
|-----------|--------------|
| `secid:entity/ibm` | IBM as an organization |
| `secid:weakness/owasp/llm-top10` | Complementary LLM risk taxonomy |
| `secid:weakness/mit/ai-risk-repository` | More comprehensive academic taxonomy |
...
```
secid:weakness/ibm/ai-risk-atlas#RISK-NAME
secid:weakness/ibm/ai-risk-atlas#hallucination
secid:weakness/ibm/ai-risk-atlas#prompt-injection
```
