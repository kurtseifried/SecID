...
operator: "secid:entity/stanford"
...
sources:
  air-bench:
    ...
    versions:
      - "2024"
    examples:
      - "secid:weakness/stanford/air-bench@2024#privacy-pii"
      - "secid:weakness/stanford/air-bench@2024#manipulation-persuasion"
  ...
  helm-safety:
    ...
    versions:
      - "1.0"
    examples:
      - "secid:weakness/stanford/helm-safety#toxicity"
      - "secid:weakness/stanford/helm-safety#bias"
---
...
```
secid:weakness/stanford/air-bench@2024#<category>
```
...
```
secid:weakness/stanford/helm-safety#<dimension>
```
