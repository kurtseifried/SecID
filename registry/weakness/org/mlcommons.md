...
sources:
  ailuminate:
    ...
    versions:
      - "1.0"
    examples:
      - "secid:weakness/mlcommons.org/ailuminate@1.0#violent-crimes"
      - "secid:weakness/mlcommons.org/ailuminate@1.0#hate-speech"
      - "secid:weakness/mlcommons.org/ailuminate@1.0#weapons"
---
...
|-----------|--------------|
| `secid:entity/mlcommons.org` | MLCommons as an organization |
| `secid:weakness/owasp.org/llm-top10` | Complementary risk taxonomy |
| `secid:weakness/mit.edu/ai-risk-repository` | Broader academic risk repository |
...
```
secid:weakness/mlcommons.org/ailuminate@1.0#HAZARD-CATEGORY
secid:weakness/mlcommons.org/ailuminate@1.0#violent-crimes
secid:weakness/mlcommons.org/ailuminate@1.0#hate-speech
```
