...
operator: "secid:entity/oecd.org"
...
sources:
  ai-classification:
    ...
    versions:
      - "2022"
    examples:
      - "secid:weakness/oecd.org/ai-classification#autonomy-level"
      - "secid:weakness/oecd.org/ai-classification#data-input-type"
  ...
  ai-incidents:
    ...
    examples:
      - "secid:weakness/oecd.org/ai-incidents#incident-category"
  ...
  incident-framework:
    ...
    versions:
      - "2025"
    examples:
      - "secid:weakness/oecd.org/incident-framework#hazard"
      - "secid:weakness/oecd.org/incident-framework#harm"
---
...
```
secid:weakness/oecd.org/ai-classification#<dimension>
```
...
```
secid:weakness/oecd.org/ai-incidents#<category>
```
...
```
secid:weakness/oecd.org/incident-framework#<term>
```
