---
type: weakness
namespace: enisa.europa.eu
full_name: "European Union Agency for Cybersecurity"
operator: "secid:entity/enisa.europa.eu"
...
sources:
  ml-threats:
    ...
    versions:
      - "2021"
    examples:
      - "secid:weakness/enisa.europa.eu/ml-threats@2021#evasion"
      - "secid:weakness/enisa.europa.eu/ml-threats@2021#poisoning"
      - "secid:weakness/enisa.europa.eu/ml-threats@2021#model-extraction"
  ...
  ai-framework:
    ...
    versions:
      - "2023"
    examples:
      - "secid:weakness/enisa.europa.eu/ai-framework@2023#data-integrity"
      - "secid:weakness/enisa.europa.eu/ai-framework@2023#model-security"
---
...
```
secid:weakness/enisa.europa.eu/ml-threats@2021#<threat-category>
```
...
```
secid:weakness/enisa.europa.eu/ai-framework@2023#<layer>
```
