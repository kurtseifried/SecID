---
type: weakness
namespace: anthropic.com
full_name: "Anthropic"
operator: "secid:entity/anthropic.com"
...
sources:
  asl:
    ...
    versions:
      - "2.2"
    examples:
      - "secid:weakness/anthropic.com/asl#ASL-1"
      - "secid:weakness/anthropic.com/asl#ASL-2"
      - "secid:weakness/anthropic.com/asl#ASL-3"
      - "secid:weakness/anthropic.com/asl#ASL-4"
---
...
```
secid:weakness/anthropic.com/asl#ASL-N
```
