...
sources:
  risk-sources:
    ...
    versions:
      - "2024"
    examples:
      - "secid:weakness/gpai.ai/risk-sources#training-data-risks"
      - "secid:weakness/gpai.ai/risk-sources#deployment-risks"
      - "secid:weakness/gpai.ai/risk-sources#societal-risks"
---
...
|-----------|--------------|
| `secid:weakness/mit.edu/ai-risk-repository` | Broader AI risk repository |
| `secid:weakness/owasp.org/llm-top10` | LLM-specific risks |
| `secid:control/nist.gov/ai-rmf` | AI risk management framework |
...
```
secid:weakness/gpai.ai/risk-sources#RISK-CATEGORY
secid:weakness/gpai.ai/risk-sources#training-data-risks
secid:weakness/gpai.ai/risk-sources#societal-risks
```
