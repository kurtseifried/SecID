---
type: advisory
namespace: rustsec.org
full_name: "RustSec Advisory Database"
operator: "secid:entity/rustsec.org"
...
sources:
  advisories:
    ...
    examples:
      - "secid:advisory/rustsec.org/advisories#RUSTSEC-2024-0001"
      - "secid:advisory/rustsec.org/advisories#RUSTSEC-2023-0071"
---
...
```
secid:advisory/rustsec.org/advisories#RUSTSEC-YYYY-NNNN
```
