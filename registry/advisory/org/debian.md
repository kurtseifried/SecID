...
operator: "secid:entity/debian.org"
...
sources:
  dsa:
    ...
    examples:
      ...
      - "secid:advisory/debian.org/dsa#DSA-5432-2"
  dla:
    ...
    id_pattern: "DLA-\\d+-\\d+"
    examples:
      - "secid:advisory/debian.org/dla#DLA-1234-1"
      - "secid:advisory/debian.org/dla#DLA-3456-2"
  tracker:
    ...
    examples:
      - "secid:advisory/debian.org/tracker#CVE-2024-1234"
      - "secid:advisory/debian.org/tracker#CVE-2023-44487"
  bts:
    ...
    id_pattern: "\\d+"
    examples:
      - "secid:advisory/debian.org/bts#1012345"
      - "secid:advisory/debian.org/bts#987654"
---
...
```
secid:advisory/debian.org/dsa#DSA-NNNN-N
```
...
- For LTS releases, see `secid:advisory/debian.org/dla`
- For CVE tracking, see `secid:advisory/debian.org/tracker`
...
```
secid:advisory/debian.org/dla#DLA-NNNN-N
```
...
- For stable releases, see `secid:advisory/debian.org/dsa`
- For CVE tracking, see `secid:advisory/debian.org/tracker`
...
```
secid:advisory/debian.org/tracker#CVE-YYYY-NNNN
```
...
- For official advisories, see `secid:advisory/debian.org/dsa` and `secid:advisory/debian.org/dla`
...
```
secid:advisory/debian.org/bts#NNNNNNN
```
...
- For official advisories, see `secid:advisory/debian.org/dsa` and `secid:advisory/debian.org/dla`
- For CVE status, see `secid:advisory/debian.org/tracker`
