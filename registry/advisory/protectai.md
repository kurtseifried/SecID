...
operator: "secid:entity/protectai"
...
sources:
  sightline:
    ...
    examples:
      - "secid:advisory/protectai/sightline#PAI-2024-001"
  ...
  huntr:
    ...
    examples:
      - "secid:advisory/protectai/huntr#vulnerability-id"
---
...
```
secid:advisory/protectai/sightline#<id>
```
...
```
secid:advisory/protectai/huntr#<id>
```
