...
sources:
  security-bulletin:
    ...
    examples:
      - "secid:advisory/ibm/security-bulletin#bulletin-id"
  ...
  cloud:
    ...
    examples:
      - "secid:advisory/ibm/cloud#bulletin-id"
  ...
  xforce:
    ...
    examples:
      - "secid:advisory/ibm/xforce#vulnerability-id"
---
