...
operator: "secid:entity/atlassian.com"
...
sources:
  jira-security:
    ...
    examples:
      - "secid:advisory/atlassian.com/jira-security#CVE-2023-22515"
      - "secid:advisory/atlassian.com/jira-security#CONFSERVER-92475"
---
...
```
secid:advisory/atlassian.com/jira-security#CVE-YYYY-NNNN
secid:advisory/atlassian.com/jira-security#PROJECT-NNNNN
```
