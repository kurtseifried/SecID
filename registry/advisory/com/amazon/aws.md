...
operator: "secid:entity/aws.amazon.com"
...
sources:
  security-bulletins:
    ...
    examples:
      - "secid:advisory/aws.amazon.com/security-bulletins#AWS-2024-001"
  ...
  alas:
    ...
    examples:
      - "secid:advisory/aws.amazon.com/alas#ALAS2-2024-2400"
      - "secid:advisory/aws.amazon.com/alas#ALAS2023-2024-500"
---
...
```
secid:advisory/aws.amazon.com/security-bulletins#<bulletin-id>
```
...
```
secid:advisory/aws.amazon.com/alas#ALAS2-YYYY-NNNN
secid:advisory/aws.amazon.com/alas#ALAS2023-YYYY-NNN
```
