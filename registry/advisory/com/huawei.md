...
operator: "secid:entity/huawei.com"
...
sources:
  psirt:
    ...
    examples:
      - "secid:advisory/huawei.com/psirt#HWPSIRT-2024-12345"
  ...
  security-advisories:
    ...
    examples:
      - "secid:advisory/huawei.com/security-advisories#huawei-sa-xxxxx"
  ...
  security-notices:
    ...
    examples:
      - "secid:advisory/huawei.com/security-notices#huawei-sn-xxxxx"
---
...
```
secid:advisory/huawei.com/psirt#HWPSIRT-YYYY-NNNNN
```
...
```
secid:advisory/huawei.com/security-advisories#huawei-sa-<id>
```
...
```
secid:advisory/huawei.com/security-notices#huawei-sn-<id>
```
