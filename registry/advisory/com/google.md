...
sources:
  osv:
    ...
    examples:
      ...
      - "secid:advisory/google.com/osv#RUSTSEC-2024-0001"
      - "secid:advisory/google.com/osv#GO-2024-0001"
  chrome:
    ...
    examples:
      - "secid:advisory/google.com/chrome#CVE-2024-0519"
      - "secid:advisory/google.com/chrome#CVE-2023-7024"
  android:
    ...
    examples:
      - "secid:advisory/google.com/android#2024-01-01"
      - "secid:advisory/google.com/android#CVE-2024-0031"
  gcp-bulletins:
    ...
    examples:
      - "secid:advisory/google.com/gcp-bulletins#GCP-2024-001"
      - "secid:advisory/google.com/gcp-bulletins#GCP-2023-034"
  project-zero:
    ...
    id_pattern: "\\d+"
    examples:
      - "secid:advisory/google.com/project-zero#2374"
      - "secid:advisory/google.com/project-zero#1945"
---
...
```
secid:advisory/google.com/osv#{ecosystem-id}
```
...
```
secid:advisory/google.com/chrome#CVE-YYYY-NNNN
```
...
```
secid:advisory/google.com/android#YYYY-MM-DD
secid:advisory/google.com/android#CVE-YYYY-NNNN
```
...
```
secid:advisory/google.com/gcp-bulletins#GCP-YYYY-NNN
```
...
```
secid:advisory/google.com/project-zero#NNNN
```
