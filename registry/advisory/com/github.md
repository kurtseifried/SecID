...
operator: "secid:entity/github.com"
...
sources:
  ghsa:
    ...
    examples:
      - "secid:advisory/github.com/ghsa#GHSA-jfh8-c2jp-5v3q"
      - "secid:advisory/github.com/ghsa#GHSA-p6xc-xr62-6r2g"
---
...
```
secid:advisory/github.com/ghsa#GHSA-xxxx-yyyy-zzzz -> aliases -> secid:advisory/mitre.org/cve#CVE-YYYY-NNNN
```
