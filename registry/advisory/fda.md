...
sources:
  maude:
    ...
    examples:
      - "secid:advisory/fda/maude#report-number"
  ...
  aiml-devices:
    ...
    examples:
      - "secid:advisory/fda/aiml-devices#device-name"
  ...
  recalls:
    ...
    examples:
      - "secid:advisory/fda/recalls#recall-number"
---
...
```
secid:advisory/fda/aiml-devices#<device-identifier>
```
