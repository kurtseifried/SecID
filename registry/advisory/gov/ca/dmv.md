...
sources:
  av-collision:
    ...
    examples:
      - "secid:advisory/dmv.ca.gov/av-collision#report-id"
  ...
  av-disengagement:
    ...
    examples:
      - "secid:advisory/dmv.ca.gov/av-disengagement#report-id"
  ...
  av-permits:
    ...
    examples:
      - "secid:advisory/dmv.ca.gov/av-permits"
---
