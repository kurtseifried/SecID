---
type: reference
namespace: aisi.gov.uk
full_name: "AI Safety Institutes"
operator: "secid:entity/aisi.gov.uk"
...
sources:
  uk:
    ...
    examples:
      - "secid:reference/aisi.gov.uk/uk"
      - "secid:reference/aisi.gov.uk/uk#inspect"
  ...
  us:
    ...
    examples:
      - "secid:reference/aisi.gov.uk/us"
  ...
  japan:
    ...
    examples:
      - "secid:reference/aisi.gov.uk/japan"
  ...
  international:
    ...
    examples:
      - "secid:reference/aisi.gov.uk/international"
---
