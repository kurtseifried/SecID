...
```
secid:reference/acm.org/{doi-suffix}
secid:reference/acm.org/10.1145/3319535.3354229
```

Note: ACM uses DOIs starting with `10.1145/`. The full DOI can also be referenced via `secid:reference/doi.org/10.1145/...`
