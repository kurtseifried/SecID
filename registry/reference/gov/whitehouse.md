...
```
secid:reference/whitehouse.gov/{id}
...
```
reference/whitehouse.gov/eo-14110 → precedes → regulation/govinfo.gov/ai-...
reference/whitehouse.gov/m-24-10 → implements → reference/whitehouse.gov/eo-14110
```
