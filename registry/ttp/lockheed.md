...
operator: "secid:entity/lockheed"
...
sources:
  killchain:
    ...
    versions:
      - "1.0"
    examples:
      - "secid:ttp/lockheed/killchain#reconnaissance"
      - "secid:ttp/lockheed/killchain#weaponization"
      - "secid:ttp/lockheed/killchain#delivery"
      - "secid:ttp/lockheed/killchain#exploitation"
      - "secid:ttp/lockheed/killchain#installation"
      - "secid:ttp/lockheed/killchain#c2"
      - "secid:ttp/lockheed/killchain#actions-on-objectives"
---
...
```
secid:ttp/lockheed/killchain#<phase>
```
