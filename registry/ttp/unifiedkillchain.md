---
type: ttp
namespace: unifiedkillchain
full_name: "Unified Kill Chain"
operator: "secid:entity/unifiedkillchain"
...
sources:
  ukc:
    ...
    versions:
      - "2.2"
    examples:
      - "secid:ttp/unifiedkillchain/ukc#initial-foothold"
      - "secid:ttp/unifiedkillchain/ukc#network-propagation"
      - "secid:ttp/unifiedkillchain/ukc#action-on-objectives"
---
...
```
secid:ttp/unifiedkillchain/ukc#<phase>
secid:ttp/unifiedkillchain/ukc#<tactic>
```
