...
sources:
  framework:
    ...
    versions:
      - "1.3.7"
    examples:
      - "secid:ttp/veriscommunity.net/framework#action.hacking"
      - "secid:ttp/veriscommunity.net/framework#action.malware"
      - "secid:ttp/veriscommunity.net/framework#action.social"
      - "secid:ttp/veriscommunity.net/framework#actor.external"
---
...
```
secid:ttp/veriscommunity.net/framework#<category>.<subcategory>
```
...
```
secid:ttp/veriscommunity.net/framework#actor.external
secid:ttp/veriscommunity.net/framework#actor.internal
secid:ttp/veriscommunity.net/framework#actor.partner
```
...
secid:ttp/veriscommunity.net/framework#action.malware
secid:ttp/veriscommunity.net/framework#action.social
secid:ttp/veriscommunity.net/framework#action.misuse
secid:ttp/veriscommunity.net/framework#action.physical
secid:ttp/veriscommunity.net/framework#action.error
secid:ttp/veriscommunity.net/framework#action.environmental
```
...
```
secid:ttp/veriscommunity.net/framework#asset.server
secid:ttp/veriscommunity.net/framework#asset.network
secid:ttp/veriscommunity.net/framework#asset.user-device
```
...
```
secid:ttp/veriscommunity.net/framework#attribute.confidentiality
secid:ttp/veriscommunity.net/framework#attribute.integrity
secid:ttp/veriscommunity.net/framework#attribute.availability
```
