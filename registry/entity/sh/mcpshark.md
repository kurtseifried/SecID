---
type: entity
namespace: mcpshark.sh
full_name: "MCPShark"
operator: "secid:entity/mcpshark.sh"
...
|-----------|--------------|
| `secid:control/mcpshark.sh/smart` | Security controls provided by Smart Scan |
| `secid:weakness/owasp.org/llm-top10` | Vulnerability categories detected |
| `secid:weakness/owasp.org/agentic-top10` | Agent risks detected |
...
|------|-------|--------------|
| Control | `secid:control/mcpshark.sh/smart` | Security checks performed |
| Weakness | `secid:weakness/owasp.org/llm-top10` | Mapped vulnerability categories |
| Weakness | `secid:weakness/owasp.org/agentic-top10` | Agent-specific risks detected |
