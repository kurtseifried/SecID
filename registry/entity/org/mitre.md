...
|------|-----------|-----------------|
| `cve` | Common Vulnerabilities and Exposures | `secid:advisory/mitre.org/cve#*` |
| `cwe` | Common Weakness Enumeration | `secid:weakness/mitre.org/cwe#*` |
| `attack` | MITRE ATT&CK | `secid:ttp/mitre.org/attack#*` |
| `atlas` | Adversarial Threat Landscape for AI Systems | `secid:ttp/mitre.org/atlas#*` |
| `capec` | Common Attack Pattern Enumeration and Classification | `secid:ttp/mitre.org/capec#*` |

## Examples

```
secid:entity/mitre.org/cve      # The CVE program
secid:entity/mitre.org/attack   # The ATT&CK framework
secid:entity/mitre.org/atlas    # The ATLAS framework
```
