...
secid:entity/redhat.com/openshift   # OpenShift platform generally

# Specific variants (when distinction matters)
secid:entity/redhat.com/rosa        # ROSA - the managed AWS service
secid:entity/redhat.com/aro         # ARO - the managed Azure service

# Other products
secid:entity/redhat.com/rhel        # RHEL operating system
secid:entity/redhat.com/ansible     # Ansible automation
```
