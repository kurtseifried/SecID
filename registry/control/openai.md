...
sources:
  model-spec:
    ...
    versions:
      - "2024"
    examples:
      - "secid:control/openai/model-spec@2024#objectives"
      - "secid:control/openai/model-spec@2024#behaviors"
  ...
  preparedness:
    ...
    versions:
      - "beta"
    examples:
      - "secid:control/openai/preparedness#risk-categories"
      - "secid:control/openai/preparedness#capability-thresholds"
  ...
  red-teaming:
    ...
    examples:
      - "secid:control/openai/red-teaming"
  ...
  system-cards:
    ...
    examples:
      - "secid:control/openai/system-cards#gpt-4o"
      - "secid:control/openai/system-cards#o1"
---
...
```
secid:control/openai/model-spec@2024#<section>
```
...
```
secid:control/openai/preparedness#<component>
```
...
```
secid:control/openai/system-cards#<model>
```
