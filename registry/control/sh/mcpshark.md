...
sources:
  smart:
    ...
    id_pattern: "[a-z-]+"
    examples:
      - "secid:control/mcpshark.sh/smart#agent-analysis"
      - "secid:control/mcpshark.sh/smart#privilege-escalation-detection"
      - "secid:control/mcpshark.sh/smart#owasp-mapping"
---
...
```
secid:entity/mcpshark.sh/smart  -> What the tool is
secid:control/mcpshark.sh/smart -> What security checks it provides
```
...
```
secid:control/mcpshark.sh/smart#CAPABILITY
secid:control/mcpshark.sh/smart#agent-analysis
secid:control/mcpshark.sh/smart#owasp-mapping
```
...
```
secid:entity/mcpshark.sh/smart
```
