...
sources:
  ccm:
    ...
    examples:
      - "secid:control/csa/ccm@4.0#IAM-01"
      - "secid:control/csa/ccm@4.0#DSP-07"
  ...
  aicm:
    ...
    versions:
      - "1.0"
    examples:
      - "secid:control/csa/aicm@1.0#AI-GOV-01"
      - "secid:control/csa/aicm@1.0#AI-DAT-03"
...
```
secid:control/csa/ccm@4.0#XXX-NN
```
...
```
secid:control/csa/aicm@1.0#AI-XXX-NN
```
