---
type: control
namespace: imda.gov.sg
full_name: "Singapore Government"
operator: "secid:entity/imda.gov.sg"
...
sources:
  ai-verify:
    ...
    versions:
      - "2.0"
    examples:
      - "secid:control/imda.gov.sg/ai-verify@2.0#transparency"
      - "secid:control/imda.gov.sg/ai-verify@2.0#fairness"
  ...
  model-governance:
    ...
    versions:
      - "2.0"
    examples:
      - "secid:control/imda.gov.sg/model-governance@2.0"
---
...
```
secid:control/imda.gov.sg/ai-verify@2.0#<principle>
```
