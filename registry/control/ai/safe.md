...
sources:
  harmbench:
    ...
    versions:
      - "2024"
    examples:
      - "secid:control/safe.ai/harmbench#standard"
      - "secid:control/safe.ai/harmbench#contextual"
  ...
  wmdp:
    ...
    versions:
      - "2024"
    examples:
      - "secid:control/safe.ai/wmdp#biosecurity"
      - "secid:control/safe.ai/wmdp#cybersecurity"
---
...
```
secid:control/safe.ai/harmbench#<category>
```
...
```
secid:control/safe.ai/wmdp#<domain>
```
