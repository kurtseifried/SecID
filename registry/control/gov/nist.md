...
sources:
  800-53:
    ...
    examples:
      ...
      - "secid:control/nist.gov/800-53@rev5#AC-2"
      - "secid:control/nist.gov/800-53@rev5#SI-7"
  ...
  csf:
    ...
    versions:
      ...
      - "1.1"
    examples:
      - "secid:control/nist.gov/csf@2.0#GV.RM-01"
      - "secid:control/nist.gov/csf@2.0#ID.AM-01"
      - "secid:control/nist.gov/csf@2.0#PR.AC-01"
---
...
```
secid:control/nist.gov/800-53[@VERSION]#CONTROL-ID
secid:control/nist.gov/800-53@rev5#AC-1
secid:control/nist.gov/800-53#AC-1           # Current version
```
...
```
secid:control/nist.gov/csf[@VERSION]#CONTROL-ID
secid:control/nist.gov/csf@2.0#GV.RM-01
secid:control/nist.gov/csf#PR.AC-01          # Current version
```
