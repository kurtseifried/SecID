...
operator: "secid:entity/ieee.org"
...
sources:
  ethically-aligned:
    ...
    versions:
      - "1.0"
    examples:
      - "secid:control/ieee.org/ethically-aligned#human-rights"
      - "secid:control/ieee.org/ethically-aligned#well-being"
  ...
  7000:
    ...
    versions:
      - "2021"
    examples:
      - "secid:control/ieee.org/7000@2021"
  ...
  7001:
    ...
    versions:
      - "2021"
    examples:
      - "secid:control/ieee.org/7001@2021"
  ...
  7002:
    ...
    versions:
      - "2022"
    examples:
      - "secid:control/ieee.org/7002@2022"
  ...
  7010:
    ...
    versions:
      - "2020"
    examples:
      - "secid:control/ieee.org/7010@2020"
---
...
```
secid:control/ieee.org/ethically-aligned#<principle>
```
