...
sources:
  27001:
    ...
    versions:
      ...
      - "2013"
    examples:
      - "secid:control/iso.org/27001@2022#A.5.1"
      - "secid:control/iso.org/27001@2022#A.8.2"
      - "secid:control/iso.org/27001@2013#A.5.1.1"
  ...
  27002:
    ...
    versions:
      ...
      - "2013"
    examples:
      - "secid:control/iso.org/27002@2022#5.1"
      - "secid:control/iso.org/27002@2022#8.2"
  ...
  42001:
    ...
    versions:
      - "2023"
    examples:
      - "secid:control/iso.org/42001@2023"
  ...
  23894:
    ...
    versions:
      - "2023"
    examples:
      - "secid:control/iso.org/23894@2023"
  ...
  24028:
    ...
    versions:
      - "2020"
    examples:
      - "secid:control/iso.org/24028@2020"
  ...
  24029:
    ...
    versions:
      - "2021"
    examples:
      - "secid:control/iso.org/24029@2021"
---
...
```
secid:control/iso.org/27001[@VERSION]#A.N.N
secid:control/iso.org/27001@2022#A.5.1
secid:control/iso.org/27001@2013#A.5.1.1
```
...
```
secid:control/iso.org/27002[@VERSION]#N.N
secid:control/iso.org/27002@2022#5.1
secid:control/iso.org/27002@2022#8.2
```
...
- `secid:control/iso.org/27001@2022#A.5.1` - Control objective
- `secid:control/iso.org/27002@2022#5.1` - Implementation guidance
