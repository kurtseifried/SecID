---
type: control
namespace: allenai.org
full_name: "Allen Institute for AI"
operator: "secid:entity/allenai.org"
...
sources:
  decodingtrust:
    ...
    versions:
      - "2024"
    examples:
      - "secid:control/allenai.org/decodingtrust#toxicity"
      - "secid:control/allenai.org/decodingtrust#privacy"
  ...
  realtoxicityprompts:
    ...
    examples:
      - "secid:control/allenai.org/realtoxicityprompts"
---
...
```
secid:control/allenai.org/decodingtrust#<perspective>
```
