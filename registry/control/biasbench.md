...
sources:
  bbq:
    ...
    versions:
      - "2022"
    examples:
      - "secid:control/biasbench/bbq#age"
      - "secid:control/biasbench/bbq#gender"
  ...
  winobias:
    ...
    examples:
      - "secid:control/biasbench/winobias"
  ...
  stereoset:
    ...
    examples:
      - "secid:control/biasbench/stereoset#gender"
      - "secid:control/biasbench/stereoset#race"
  ...
  crowspairs:
    ...
    examples:
      - "secid:control/biasbench/crowspairs"
---
...
```
secid:control/biasbench/bbq#<category>
```
...
```
secid:control/biasbench/stereoset#<domain>
```
