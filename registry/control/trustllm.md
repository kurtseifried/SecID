...
sources:
  benchmark:
    ...
    versions:
      - "2024"
    examples:
      - "secid:control/trustllm/benchmark#truthfulness"
      - "secid:control/trustllm/benchmark#safety"
      - "secid:control/trustllm/benchmark#fairness"
---
...
```
secid:control/trustllm/benchmark#<dimension>
```
