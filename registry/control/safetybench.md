...
sources:
  benchmark:
    ...
    versions:
      - "2024"
    examples:
      - "secid:control/safetybench/benchmark#offensiveness"
      - "secid:control/safetybench/benchmark#ethics"
---
...
```
secid:control/safetybench/benchmark#<category>
```
