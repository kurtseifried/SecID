...
sources:
  altai:
    ...
    versions:
      - "2020"
    examples:
      - "secid:control/eu/altai@2020#human-agency"
      - "secid:control/eu/altai@2020#transparency"
  ...
  ethics-guidelines:
    ...
    versions:
      - "2019"
    examples:
      - "secid:control/eu/ethics-guidelines@2019"
  ...
  ai-act:
    ...
    versions:
      - "2024"
    examples:
      - "secid:control/eu/ai-act@2024#high-risk"
      - "secid:control/eu/ai-act@2024#prohibited"
---
...
```
secid:control/eu/altai@2020#<requirement>
```
...
```
secid:control/eu/ai-act@2024#<category>
```
