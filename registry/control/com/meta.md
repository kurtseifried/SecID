...
operator: "secid:entity/meta.com"
...
sources:
  purple-llama:
    ...
    examples:
      - "secid:control/meta.com/purple-llama#llama-guard"
      - "secid:control/meta.com/purple-llama#prompt-guard"
      - "secid:control/meta.com/purple-llama#code-shield"
  ...
  cyberseceval:
    ...
    versions:
      - "4.0"
    examples:
      - "secid:control/meta.com/cyberseceval#insecure-code"
      - "secid:control/meta.com/cyberseceval#cyberattack-helpfulness"
      - "secid:control/meta.com/cyberseceval#prompt-injection"
---
...
```
secid:control/meta.com/purple-llama#<tool>
```
...
```
secid:control/meta.com/cyberseceval#<benchmark>
```
