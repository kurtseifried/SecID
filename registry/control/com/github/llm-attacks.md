---
type: control
namespace: github.com/llm-attacks
full_name: "AdvBench"
...
sources:
  benchmark:
    ...
    versions:
      - "2023"
    examples:
      - "secid:control/github.com/llm-attacks/benchmark#harmful-behaviors"
      - "secid:control/github.com/llm-attacks/benchmark#harmful-strings"
---
...
```
secid:control/github.com/llm-attacks/benchmark#<dataset>
```
