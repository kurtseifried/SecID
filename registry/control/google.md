...
sources:
  saif:
    ...
    versions:
      - "1.0"
    examples:
      - "secid:control/google/saif#foundation"
      - "secid:control/google/saif#detection"
  ...
  frontier-safety:
    ...
    versions:
      - "2.0"
    examples:
      - "secid:control/google/frontier-safety#critical-capability-levels"
      - "secid:control/google/frontier-safety#evaluation-protocols"
---
...
```
secid:control/google/saif#<element>
```
...
```
secid:control/google/frontier-safety#<element>
```
