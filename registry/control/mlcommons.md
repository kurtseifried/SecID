...
sources:
  ai-safety:
    ...
    examples:
      - "secid:control/mlcommons/ai-safety#hazard-taxonomy"
      - "secid:control/mlcommons/ai-safety#benchmark"
  ...
  croissant:
    ...
    versions:
      - "1.0"
    examples:
      - "secid:control/mlcommons/croissant@1.0"
  ...
  mlperf:
    ...
    examples:
      - "secid:control/mlcommons/mlperf#training"
      - "secid:control/mlcommons/mlperf#inference"
---
...
```
secid:control/mlcommons/ai-safety#<component>
```
...
```
secid:control/mlcommons/mlperf#<benchmark>
```
