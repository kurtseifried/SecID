...
sources:
  task-standard:
    ...
    versions:
      - "2024"
    examples:
      - "secid:control/metr/task-standard"
  ...
  evaluations:
    ...
    examples:
      - "secid:control/metr/evaluations#autonomy"
      - "secid:control/metr/evaluations#capability"
---
...
```
secid:control/metr/evaluations#<type>
```
