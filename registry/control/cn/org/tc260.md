...
sources:
  ai-safety-governance:
    ...
    versions:
      ...
      - "2.0"
    examples:
      - "secid:control/tc260.org.cn/ai-safety-governance@1.0"
      - "secid:control/tc260.org.cn/ai-safety-governance@2.0#endemic-risks"
      - "secid:control/tc260.org.cn/ai-safety-governance@2.0#open-source-governance"
---
...
|-----------|--------------|
| `secid:control/nist.gov/ai-rmf` | US AI risk management framework |
| `secid:control/concordia-ai.com/frontier-ai-rmf` | Frontier AI risk management |
| `secid:reference/gov.uk/ai-safety-report` | International AI safety collaboration |
...
```
secid:control/tc260.org.cn/ai-safety-governance@VERSION
secid:control/tc260.org.cn/ai-safety-governance@2.0#endemic-risks
secid:control/tc260.org.cn/ai-safety-governance@2.0#loss-of-control
```
